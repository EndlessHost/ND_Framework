...
server_exports {
    ...
    "transferBank", -- transferBank(amount, player, target)
    "giveCashToClosestTarget", -- giveCashToClosestTarget(amount, player)
    "withdrawMoney", -- withdrawMoney(amount, player)
    "depositMoney", -- depositMoney(amount, player)
    "deductMoney" -- deductMoney(amount, player, to)
    "addMoney" -- addMoney(amount, player, to)
}
